...
describe('Portfolio', () => {
  ...
  test('simulation', async () => {
    ...
    const postSimulation = await portfolio.update('0x77777777789A8BBEE6C64381e5E89E501fb0e4c8', {
  ...
  test('price cache works', async () => {
    ...
    const resultTwo = await portfolio.update('0x77777777789A8BBEE6C64381e5E89E501fb0e4c8', {
      priceCache,
      priceRecency: 60000
    })
