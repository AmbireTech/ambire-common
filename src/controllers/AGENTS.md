...
- **PrivacyPoolsController** – Manages Privacy Pools (0xBow) shielded notes per recovery phrase: syncs pools, reports approved/pending balances, and builds deposit, withdrawal and public-reclaim operations.
