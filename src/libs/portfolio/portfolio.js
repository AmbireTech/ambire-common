...
const multiOracle_json_1 = require("./multiOracle.json");
...
class Portfolio {
    constructor(fetch, provider, network) {
        ...
        this.deploylessTokens = deployless_1.fromDescriptor(provider, multiOracle_json_1.balanceOracle, !network.rpcNoStateOverride);
        this.deploylessNfts = deployless_1.fromDescriptor(provider, multiOracle_json_1.nftOracle, !network.rpcNoStateOverride);
    }
