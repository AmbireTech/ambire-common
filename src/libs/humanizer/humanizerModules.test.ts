...
describe('module tests', () => {
  ...
  test('visualization to text', async () => {
    const expectedTexification = [
      'Swap XLRT for at least MATIC and send it to 0x0000000000000000000000000000000000000000 (0x000...000) already expired',
      ...
      'Swap SHARES for at least USDC and send it to 0xca124B356bf11dc153B886ECB4596B5cb9395C41 (0xca1...C41) already expired',
      ...
      'Deposit STETH to Aave lending pool on befalf of 0x7F4cF2E68f968cc050B3783268C474a15b8BDC2e (0x7F4...C2e)',
