...
export async function getUniV3Positions(
    ...
    const [result] = await deploylessDeFiPositionsGetter.call('getUniV3Position',[userAddr, nonfungiblePositionManagerAddr, factoryAddr])
    ...
    const positions: Positions[] = data.map((pos: any) => {
