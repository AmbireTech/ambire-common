export function uniV3DataToPortfolioPosition(liquidity: bigint, sqrtPriceX96: bigint, tickLow: bigint, tickHigh: bigint) {
    const Q96:any = 2 ** 96
    ...
    function getTokenAmounts(liquidity: number, sqrtPriceX96: number, tickLow: number, tickHigh: number){
        let isInRage = false
