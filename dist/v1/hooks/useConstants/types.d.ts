...
type HumanizerInfoAbisKeysType = 'AaveWethGatewayV2' | 'PancakeRouter' | 'UniV2Router' | 'UniV3Router' | 'UniV3Router2' | 'WETH' | 'AaveLendingPoolV2' | 'MovrRouter' | 'MovrAnyswap' | 'ERC721' | 'YearnVault' | 'IdentityFactory' | 'Batcher' | 'StakingPool' | 'WyvernExchange' | 'Swappin' | 'ERC20' | 'SwappinOwn';
