...
export type IUiController = ControllerInterface<InstanceType<typeof import('../controllers/ui//ui').UiController>>;
export type View = {
    id: string;
...
export type UiManager = {
    ...
    message: {
        sendToastMessage: (message: string, options?: {
            timeout?: number;
            type?: 'error' | 'success' | 'info' | 'warning';
            sticky?: boolean;
        }) => void;
        sendUiMessage: (params: {}) => void;
        sendNavigateMessage: (viewId: string, route: string, params: {
            [key: string]: any;
        }) => void;
    };
};
