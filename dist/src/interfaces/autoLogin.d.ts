...
type IAutoLoginController = ControllerInterface<InstanceType<typeof import('../controllers/autoLogin/autoLogin').AutoLoginController>>;
export type { IAutoLoginController, AutoLoginPolicy, AutoLoginPoliciesByAccount, AutoLoginSettings, AutoLoginStatus, SiweValidityStatus, DefaultAutoLoginPolicy };
