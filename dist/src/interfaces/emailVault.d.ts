...
export type IEmailVaultController = ControllerInterface<InstanceType<typeof import('../controllers/emailVault/emailVault').EmailVaultController>>;
...
export declare enum OperationRequestType {
...
export interface EmailVaultData {
    ...
    email: string;
    availableAccounts: {
        [addr: string]: EmailVaultAccountInfo;
    };
    availableSecrets: {
        [key: string]: EmailVaultSecret;
    };
