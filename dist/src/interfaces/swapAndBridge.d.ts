...
export type ISwapAndBridgeController = ControllerInterface<InstanceType<typeof import('../controllers/swapAndBridge/swapAndBridge').SwapAndBridgeController>>;
...
export interface SwapProvider {
    ...
    quote({ fromAsset, fromChainId, fromTokenAddress, toAsset, toChainId, toTokenAddress, fromAmount, userAddress, sort, accountNativeBalance, nativeSymbol }: ProviderQuoteParams): Promise<SwapAndBridgeQuote>;
