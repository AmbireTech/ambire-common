...
export const genericErc721Humanizer = (accountOp, currentIrCalls) => {
    ...
    const matcher = {
        ...
        [toFunctionSelector(erc721SafeTransferFromAbi[0])]: (call) => nftTransferVisualization(call, erc721SafeTransferFromAbi),
        [toFunctionSelector(erc721TransferFromAbi[0])]: (call) => nftTransferVisualization(call, erc721TransferFromAbi)
    };
...
export const genericErc20Humanizer = ({ accountAddr }, currentIrCalls) => {
    const matcher = {
