...
const stethIface = new ethers_1.Interface(Lido_1.stETH);
const LidoModule = (accOp, calls) => {
    const newCalls = calls.map((call) => {
        ...
        else if ((0, ethers_1.isAddress)(call.to) && (0, ethers_1.getAddress)(call.to) === ST_ETH_ADDRESS) {
            if (call.data.startsWith(stethIface.getFunction('submit').selector)) {
                return {
                    ...call,
                    fullVisualization: [(0, utils_1.getAction)('Stake'), (0, utils_1.getToken)(ST_ETH_ADDRESS, call.value)]
                };
            }
        }
        return call;
