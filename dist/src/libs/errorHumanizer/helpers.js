...
function getGenericMessageFromType(errorType, reason, messagePrefix, lastResortMessage, withReason = true) {
    const messageSuffixNoSupport = withReason ? (0, helpers_1.getErrorCodeStringFromReason)(reason ?? '') : '';
