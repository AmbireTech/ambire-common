...
const BROADCAST_OR_ESTIMATION_ERRORS = [
    ...
    },
    {
        ...
        message: 'of a RPC request that contains invalid or missing parameters. Please try again later or contact support.'
    },
    {
        reasons: ['Too Many Requests'],
        message: 'your wallet has sent too many requests in a short time. Please wait a moment and try again.'
    },
    {
        reasons: ['SERVER_ERROR'],
        message: 'of a server error of the RPC provider. Please wait a moment or try changing the RPC provider in settings.'
    },
    ...
    },
    {
        ...
        message: 'of insufficient funds for the transaction fee. Please add more fee tokens to your account and try again.'
    },
    {
        reasons: ['transfer amount exceeds balance'],
        message: 'the transfer amount exceeds your account balance. Please check your balance or adjust the transfer amount.'
    },
    {
        reasons: ['ERC721: insufficient balance for transfer'],
        message: 'you do not have enough of the specified NFT in your account. Please check your balance or adjust the transfer amount.'
    },
    {
    ...
    // Smart Accounts
    {
        ...
        message: 'the gas sponsorship was refused by the app. Please try again by paying for the gas instead'
    },
    {
    ...
    {
        reasons: ['80'],
        message: "the smart contract you're interacting with doesn't support this operation. This could be due to contract restrictions, insufficient permissions, or specific conditions that haven't been met. Please review the requirements of this operation or consult the contract documentation.",
        isExactMatch: true
    },
    {
        reasons: ['STF'],
        message: 'of one of the following reasons: missing approval, insufficient approved amount, the amount exceeds the account balance.',
        isExactMatch: true
    },
    {
    ...
    {
        reasons: ['0xcd21db4f'],
        message: 'the token permit or signed approval has expired (Permit2 / AllowanceHolder). Open the dapp again and submit a fresh approval or quote so the signature deadline is renewed.'
    },
    {
        reasons: ['0x7b36c479'],
        message: 
    ...
    {
        reasons: ['0x4feac00c'],
        message: 'the Swap path is invalid. Return to the app and reinitiate the swap if you wish to proceed.'
    },
    {
        reasons: ['0x6679996d'],
...
const BROADCAST_ERRORS = [
    ...
    },
    {
        ...
        message: 'the fee set for the transaction is lower than the network’s current base fee. Please try again with a higher fee.'
    },
    {
...
const ESTIMATION_ERRORS = [
    {
        reasons: ['ConnectivityError'],
        message: 'of a network error. Please check your internet connection or contact support if the issue persists.'
    },
    {
        reasons: ['SPOOF_ERROR', 'INSUFFICIENT_PRIVILEGE'],
        message: 'your account key lacks the necessary permissions. Ensure that you have authorization to sign or use an account with sufficient privileges.'
    },
    {
        reasons: [
    ...
    },
    {
        ...
        message: 'the NFT you are trying to mint is already minted. This can also happen if you have batched multiple mint transactions for the same NFT.'
    },
    {
        reasons: ['ERC721: token does not exist'],
        message: 'the NFT you are trying to interact with does not exist. Ensure you are using the correct token ID.'
    },
    {
    ...
    // Rare contract errors
    {
        ...
        message: 'your account lacks the necessary permissions to perform this action. Please contact the contract owner or ensure you have the required role.'
    },
    {
        reasons: ['Pausable: paused'],
        message: 'the contract is currently paused. Please wait until it is active or contact the contract owner for more information.'
    },
    {
        reasons: ['Contract code size exceeds'],
        message: 'the contract’s size exceeds the EVM limit for deployment. Please ensure the contract is optimized before redeploying.'
    },
    {
