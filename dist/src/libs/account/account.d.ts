...
export declare const isAmbireV1LinkedAccount: (factoryAddr?: string) => boolean;
export declare const isAmbireV2Account: (factoryAddr?: string) => boolean;
...
export declare const getDefaultSelectedAccount: (accounts: Account[]) => Account;
...
export declare function canBecomeSmarterOnChain(network: Network, acc: Account, state: AccountOnchainState): boolean;
