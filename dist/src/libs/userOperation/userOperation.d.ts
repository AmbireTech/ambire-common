...
import { PackedUserOperation, UserOperation, UserOperationEventData, UserOpRequestType } from './types';
...
export declare function getUserOperation(account: Account, accountState: AccountOnchainState, accountOp: AccountOp, bundler: BUNDLER, entryPointSig?: string, eip7702Auth?: EIP7702Auth): UserOperation;
