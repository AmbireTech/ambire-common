...
import { getProxyDeployBytecode, getStorageSlotsFromArtifact } from './deploy';
export async function getBytecode(priLevels) {
...
export async function get4437Bytecode(network, priLevels) {
