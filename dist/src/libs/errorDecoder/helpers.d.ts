...
declare const truncateReason: (reason?: string) => string;
...
export { panicErrorCodeToReason, getErrorCodeStringFromReason, isReasonValid, getDataFromError, formatReason, countUnicodeLettersAndNumbers, truncateReason };
