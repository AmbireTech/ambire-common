...
class PortfolioViewBuilder {
     ...
     */
    isNonInternalNetworkAdded = false;
    static isNetworkReady = (networkData) => {
    ...
    static isLoadingFromScratch(networkData, isManualUpdate) {
        return ((!PortfolioViewBuilder.isNetworkReady(networkData) || isManualUpdate) &&
    ...
    addNetworkData(chainId, networkData, isManualUpdate) {
        ...
        const loadingFromScratch = PortfolioViewBuilder.isLoadingFromScratch(networkData, isManualUpdate);
    ...
    build(shouldShowPartialResult, strippedPortfolioState) {
        ...
        return {
            ...
            defiPositions: this.defiPositions.sort((a, b) => {
                if (b.providerName === 'Ambire' && a.providerName !== 'Ambire')
                    return 1;
                if (a.providerName === 'Ambire' && b.providerName !== 'Ambire')
                    return -1;
