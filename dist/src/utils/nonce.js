...
export async function getRelayerNonce(activity, op, provider) {
    ...
    const sameNonceBroadcast = lastFiveTxns.filter((subOp) => subOp.nonce === failedNonce && subOp.status !== AccountOpStatus.Failure);
