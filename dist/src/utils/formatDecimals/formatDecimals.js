...
const cacheForNumberFormatters = {};
...
const formatNumber = (value, withDollarPrefix, maxDecimals, sign, type) => {
    ...
    const maximumFractionDigits = Math.min(Math.max(minimumFractionDigits, maxDecimals), MAX_SUPPORTED_DECIMALS_BY_FORMATTER);
