...
import { AddNetworkRequestParams, ChainId, INetworksController, Network, NetworkInfo, NetworkInfoLoading } from '../../interfaces/network';
 ...
 */
export declare class NetworksController extends EventEmitter implements INetworksController {
    #private;
     ...
     *
     */
    mergeRelayerNetworks(currentNetworks: {
        [key: string]: Network;
    }): Promise<{
        mergedNetworks: {
            [key: string]: Network;
