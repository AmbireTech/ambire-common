 ...
 *   m / purpose' / coin_type' / account' / change / address_index
 */
export declare const BIP44_STANDARD_TESTNET_DERIVATION_TEMPLATE = "m/44'/1'/0'/0/<account>";
export type HD_PATH_TEMPLATE_TYPE = typeof BIP44_STANDARD_DERIVATION_TEMPLATE | typeof BIP44_LEDGER_DERIVATION_TEMPLATE | typeof LEGACY_POPULAR_DERIVATION_TEMPLATE | typeof BIP44_STANDARD_TESTNET_DERIVATION_TEMPLATE;
